...
class DocumentCreateRequest(DocumentBaseModel):
    """
    Model for document create request.
    """
    pass

class DocumentUpdateRequest(DocumentBaseModel):
    """
