...
async def get_note(
    ...
    claim:AuthClaim = request.state.claim
    return await Controller().show(uid, request, claim)
...
async def update_note(
    ...
    """
    Update a note with the given uid and new title and content.
    """
...
async def delete_note(
    uid: str,
    request: Request = CurrentRequest()) -> Any:
    """ Delete a note with the given uid.
    """
    claim:AuthClaim = request.state.claim
    return await Controller().delete(uid, request, claim)
